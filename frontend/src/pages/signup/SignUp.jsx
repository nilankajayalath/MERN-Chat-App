  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
            <h1 className="text-3x1 font-semiblod text-center text-gray-300">Sign Up  
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                   <label className='label'>
                    ...
                    <input type='passoword' placeholder='Enter Password' className='w-full input input-bordered h-10' 
                ...
                <div>
                   <label className='label'>
                    ...
                    <input type='passoword' placeholder='Enter Confirm Password' className='w-full input input-bordered h-10'
